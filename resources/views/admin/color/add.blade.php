...
<div class="row">
    <div class="col-sm-12 col-md-12">
        ...
        @endif
        <form action="{{route('admin.color.create')}}" class="border p-3" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-sm-12 col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="color" class="form-control" name="color" vacodelue="{{old('code')}}">
                    </div>
                </div>
                <div class="col-sm-12 col-md-6">
                    <div class="mb-3">
